...
<script type="text/javascript">
	$(function(){
		//指定id的销售机会
		$.post("${path}/saleChance/findById.action", 
		...
		/* 数据表格datagrid */
		$("#datagrid").edatagrid({
			url:'${path}/cusDevPlan/findAll.action?saleChanceId=${param.saleChanceId}',//只查询已分配咨询师的
			saveUrl:'${path}/cusDevPlan/add.action?saleChanceId=${param.saleChanceId}',
			updateUrl:'${path}/cusDevPlan/update.action?saleChanceId=${param.saleChanceId}',
			destroyUrl:'${path}/cusDevPlan/deleteById.action',
			title:'开发计划项',
			singleSelect:true,
			toolbar:'#toolbar',
			rownumbers:true,
	...
	function updateSaleChanceDevResult(devResult){
		 $.post("${path}/saleChance/updateDevResult.action",
...
<body>
	<!-- 营销机会信息面板  开始 -->
	<div id="p" class="easyui-panel" title="销售机会信息" style="width: 700px;height: 350px">
