	...
	<table id="datagrid" class="easyui-datagrid" rownumbers="true" fitColumns="true"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'chanceSource',width:100,align:'center'">机会来源</th>
				<th data-options="field:'customerName',width:80,align:'center'">客户名称</th>
				<th data-options="field:'successRate',width:80,align:'center'">成功几率</th>
				<th data-options="field:'overview',width:100,align:'center'">概要</th>
				<th data-options="field:'linkMan',width:100,align:'center'">联系电话</th>
				<th data-options="field:'linkPhone',width:100,align:'center'">角色</th>
				<th data-options="field:'description',width:100,align:'center'">角色</th>
				<th data-options="field:'createMan',width:100,align:'center'">角色</th>
				<th data-options="field:'createTime',width:100,align:'center'">角色</th>
				<th data-options="field:'assignMan',width:100,align:'center'">角色</th>
				<th data-options="field:'assignTime',width:100,align:'center'">角色</th>
				<th data-options="field:'status',width:100,align:'center'">角色</th>
				<th data-options="field:'devResult',width:100,align:'center'">角色</th>
			</tr>
		</thead>
	</table>
